...
LuigiCharacter::LuigiCharacter(SDL_Renderer* Renderer, string imagePath, Vector2f startPosition, LevelMap* map) : Character(Renderer, imagePath, startPosition, map)
{
	m_Renderer = Renderer;
